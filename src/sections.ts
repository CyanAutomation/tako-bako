...
export function renderBoardToolbar({ matches, total, undoDisabled, checkDisabled, hintDisabled, smartMarking }: { matches: number; total: number; undoDisabled: boolean; checkDisabled: boolean; hintDisabled: boolean; smartMarking: boolean }): string {
